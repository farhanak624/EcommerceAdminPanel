...
import SpesialModal from "./SpesialModal";
import { deleteDeals, getAllSpecialDeals } from "../../../../Api/ApiCall";
...
function SpecialDeels() {
  ...
  return (
    <div className="relative">
      {isOpen && <SpesialModal callback={getAllDeals} setOpen={setIsOpen} />}
      <div className="flex flex-col md:flex-row justify-between gap-4 mb-7">
        <h1 className="text-2xl font-bold ">Special Deals</h1>
        <button
          onClick={() => setIsOpen(true)}
          className="bg-navblue flex justify-center items-center max-w-[200px] text-white gap-3 px-5 p-1 rounded-lg"
        >
          <svg
            width="14"
            height="14"
      ...
      >
        <table className="min-w-full text-center  leading-normal">
          <thead className="bg-gray-200" style={{ height: "40px" }}>
            <tr>
              ...
              allDeals?.map((data) => {
                ...
                return (
                  <tr className="border-b border-gray-300 ">
                    <td className="px-25 py-1  text-left text-xs font-semibold text-gray-600 capitalize tracking-wider ">
