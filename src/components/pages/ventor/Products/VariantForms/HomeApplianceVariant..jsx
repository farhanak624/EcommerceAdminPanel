...
const HomeApplianceVariant = ({ formData, setformData, errors }) => {
        ...
        {formData.variants.map((variant, variantIndex) => (
          <div key={variantIndex}>
            ...
            <div className="flex justify-between">
              ...
              <button
              className="border p-1 rounded-md bg-bodycolur text-black flex items-center"
                type="button"
                onClick={() => {
...
export default HomeApplianceVariant;
