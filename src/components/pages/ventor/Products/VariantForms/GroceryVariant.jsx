...
const GroceryVariant = ({ formData, setformData, errors }) => {
  ...
  return (
    <>
      <div className="flex items-center justify-between mt-3 mb-2">
        ...
        <button
          className="p-2 rounded-lg text-black border border-gray-800 text-sm bg-bodycolur flex items-center"
          type="button"
          onClick={() => {
            addVariant();
          }}
