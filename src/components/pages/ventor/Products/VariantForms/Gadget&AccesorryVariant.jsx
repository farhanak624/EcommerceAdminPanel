...
const GadgetAccesorryVariant = ({ formData, setformData, errors }) => {
  ...
  const addDetail = (variantIndex) => {
    const updatedVariants = formData.variants.map((variant, vIndex) => {
      console.log(variant);
      if (vIndex === variantIndex) {
        const newDetail = { quantity: null, price: null };
      ...
      <div className="w-auto">
        {formData.variants.map((variant, variantIndex) => (
          <div key={variantIndex}>
            ...
            {variant.specifications.map((specifiaction, specificationIndex) => {
              return (
                <div
                  ...
                  <div>
                    {variant.specifications.length > 1 && (
                      <button
                        ...
                        onClick={() =>
                          removeSpecification(variantIndex, specificationIndex)
                        }
                      >
                        -
                      </button>
...
export default GadgetAccesorryVariant;
