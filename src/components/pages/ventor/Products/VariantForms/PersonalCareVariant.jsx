...
const PersonalCareVariant = ({ formData, setformData, errors }) => {
  ...
  return (
    <>
      <div className="flex justify-between mt-3">
        ...
        <button
          className="p-2 mb-2 rounded-lg text-black border border-gray-800 text-sm bg-bodycolur flex items-center"
          type="button"
          onClick={() => {
            addVariant();
          }}
...
export default PersonalCareVariant;
