...
const FurnitureVariant = ({ formData, setformData, errors }) => {
  ...
  const handleDetailChange = (e,variantIndex, detailIndex, field) => {
    console.log("hghg");
              ...
              <div key={detailIndex} className="flex gap-2 w-auto">
                <div>
                  <input
                    ...
                    onChange={(e) =>
                      handleDetailChange(e,variantIndex, detailIndex, "size")
                    }
                    placeholder="Size"
                  />
                </div>
...
export default FurnitureVariant;
